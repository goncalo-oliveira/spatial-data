...
namespace Fonix.Spatial
{
    public sealed class LineString : Geometry
    {
        ...
        {
            /// 0101000000 00000003 BF9EAF592E1BDBBF 6F445AD726844A40 BF9EAF592E1BDBBF
            ///         00000003  - number of points
        ...
        public override string ToWellKnownText()
        {
            ...
            sb.Append( string.Join( ", ", Points.Select( x => string.Format( "{1} {0}", x.Latitude, x.Longitude ) ) ) );
            sb.Append( ")" );
